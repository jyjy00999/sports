...
const NPB_KR_TO_JP: [string, string][] = [
  ...
  ['한신','阪神'], ['타이거스','阪神'],
  // 히로시마 / 카프
  ['히로시마','広島'], ['카프','広島'], ['도요카프','広島'], ['도요 카프','広島'],
  // DeNA / 베이스타스
  ['DeNA','DeNA'], ['dena','DeNA'], ['베이스타스','DeNA'], ['디이엔에이','DeNA'],
  // 주니치(추니치) / 드래건스(드래곤스)
  ['추니치','中日'], ['주니치','中日'], ['쥬니치','中日'],
  ['드래곤스','中日'], ['드래건스','中日'], ['드라곤스','中日'],
  // 야쿠르트 / 스왈로스
  ['야쿠르트','ヤクルト'], ['스왈로스','ヤクルト'], ['야크르트','ヤクルト'],
  // 소프트뱅크 / 호크스
  ['소프트뱅크','ソフトバンク'], ['호크스','ソフトバンク'], ['소프트 뱅크','ソフトバンク'],
  // 오릭스 / 버팔로스
  ['오릭스','オリックス'], ['버팔로스','オリックス'], ['버팔로즈','オリックス'],
  // 치바롯데 / 마린스
  ['치바 롯데','ロッテ'], ['치바롯데','ロッテ'], ['마린스','ロッテ'],
  // 세이부 / 라이온스
  ['세이부','西武'], ['라이온스','西武'], ['라이온즈','西武'],
  // 닛폰햄 / 파이터스
  ['닛폰햄','日本ハム'], ['니혼햄','日本ハム'], ['파이터스','日本ハム'], ['일본햄','日本ハム'],
  // 라쿠텐 / 이글스
  ['라쿠텐','楽天'], ['이글스','楽天'], ['낙천','楽天'],
];
